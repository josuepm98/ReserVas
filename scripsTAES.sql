...
CREATE TABLE `reservas`.`usuario` (
  ...
  `img` VARCHAR(255) NOT NULL DEFAULT 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/usericon1.png?alt=media&token=7f9e89f3-8385-4d26-bbeb-59e2431a656f',
...
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPeluqueria', 'cGBbJaKU33UhK4d6b72Y8w==', 'Peluqueria', 'Peluqueria Peluqueria', 'peluqueria@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/peluqueria1.jpg?alt=media&token=777d3bd7-0d65-4cb5-b5ed-ed96540cdd40');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPeluqueria1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Peluqueria1', 'Peluqueria1 Peluqueria1', 'peluqueria1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/peluqueria4.jpeg?alt=media&token=2026ba3d-9d6c-43d9-8c60-e48a9bd7c02e');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPeluqueria2', 'cGBbJaKU33UhK4d6b72Y8w==', 'Peluqueria2', 'Peluqueria2 Peluqueria2', 'peluqueria2@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/peluqueria2.jpg?alt=media&token=ca5ba015-64e8-4fc3-ad6a-2f1bdca89640');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPeluqueria3', 'cGBbJaKU33UhK4d6b72Y8w==', 'Peluqueria3', 'Peluqueria3 Peluqueria3', 'peluqueria3@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/peluqueria3.jpg?alt=media&token=7fecddc4-fea0-457f-bc83-2e4514f2a664');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaSpa1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Spa1', 'Spa1 Spa1', 'spa1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/spa1.jpg?alt=media&token=b85d274b-70e7-4376-a4ae-90fd4e8c79c0');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaSpa2', 'cGBbJaKU33UhK4d6b72Y8w==', 'Spa2', 'Spa2 Spa2', 'spa2@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/spa2.jpg?alt=media&token=11f72f82-420f-4bc8-a12d-00b6ef122caa');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaSpa3', 'cGBbJaKU33UhK4d6b72Y8w==', 'Spa3', 'Spa3 Spa3', 'spa3@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/spa3.jpg?alt=media&token=839cfd15-2fdd-4f7c-850e-387a8dcd8f5d');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaRestaurante', 'cGBbJaKU33UhK4d6b72Y8w==', 'Restaurante', 'Restaurante Restaurante', 'restaurante@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/restaurante3.jpg?alt=media&token=1afb70e1-1d9b-44e4-bc0a-555bf849f2f1');
...
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaGimnasio1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Gimnasio1', 'Gimnasio1 Gimnasio1', 'gimnasio1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/gimnasio1.jpg?alt=media&token=7e0f3d6c-d631-40f5-acd7-a51ef2daafa2');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaGimnasio2', 'cGBbJaKU33UhK4d6b72Y8w==', 'Gimnasio2', 'Gimnasio2 Gimnasio2', 'gimnasio2@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/gimnasio2.jpg?alt=media&token=63065f54-0397-4cdd-aec1-a9b0add5cbdf');
...
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPsicologo1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Psicologo1', 'Psicologo1 Psicologo1', 'psicologo1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/psicologo1.jpg?alt=media&token=d39797a8-20b2-4e07-9027-3e29207c71b9');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaPsicologo2', 'cGBbJaKU33UhK4d6b72Y8w==', 'Psicologo2', 'Psicologo2 Psicologo2', 'psicologo2@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/psicologo2.jpeg?alt=media&token=01dc036c-07d4-4c9e-a096-2c9098681093');
...
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaDepilacion1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Depilacion1', 'Depilacion1 Depilacion1', 'depilacion1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/depilacion1.jpg?alt=media&token=c049e9aa-5e7a-4744-80be-142a142bcbe4');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaExcursion1', 'cGBbJaKU33UhK4d6b72Y8w==', 'Excursion1', 'Excursion1 Excursion1', 'excursion1@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/excursion1.jpg?alt=media&token=3ef673db-09fe-4206-ae88-60fd8965dce7');
INSERT INTO `reservas`.`usuario` (`nombreUser`, `password`, `nombre`, `apellidos`, `email`, `img`) VALUES ('empresaExcursion2', 'cGBbJaKU33UhK4d6b72Y8w==', 'Excursion2', 'Excursion2 Excursion2', 'excursion2@gmail.com', 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/excursion2.jpg?alt=media&token=45d09f95-5050-4740-8743-4439eea44f25');
...
CREATE TABLE `reservas`.`planes` (
  ...
  `estado` VARCHAR(255) NOT NULL,
  `cliente` VARCHAR(255) NULL,
  `img` VARCHAR(255) NOT NULL DEFAULT 'https://firebasestorage.googleapis.com/v0/b/taes-imagenes.appspot.com/o/excursion3.jpg?alt=media&token=231479d6-8d47-4b89-928d-020fae3fe16f',
